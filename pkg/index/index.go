...
func GetIndexVulnrichment() {
	...
	resp, httpRes, err := client.IndicesAPI.IndexVulnrichmentGet(auth).Execute()
...
func GetIndexCanaries() {
	...
	resp, httpRes, err := client.IndicesAPI.IndexVulncheckCanariesGet(auth).Cve("CVE-2023-26801").Execute()
